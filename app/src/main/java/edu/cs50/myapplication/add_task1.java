...
public class add_task1 extends AppCompatActivity {
    ...
    private void populateUI(TaskEntity entity) {
            editText.setText(entity.getDetiales());
            setProirty(entity.getPriorty());

    }

    private void setProirty(int priorty) {
            switch (priorty)
            {
                case PRIORITY_HIGH:
    ...
    @Override
        ...
        public void onSaveButtonClicked()
        {
            ...
            final TaskEntity entity=new TaskEntity(descrepyion,priorty,date);
            AppExcutor.getInstance().getDiskIO().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    else
                    {
                        ...
                        dataBase.tadkDao().update(entity);
                    }
                    finish();
                }
            });
